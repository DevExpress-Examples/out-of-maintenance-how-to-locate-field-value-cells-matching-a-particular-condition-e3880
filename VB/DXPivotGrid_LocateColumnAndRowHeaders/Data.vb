...
Namespace DXPivotGrid_LocateColumnAndRowHeaders
	...
	Public NotInheritable Class PivotHelper
		...
		Public Shared Function GetData() As List(Of DataItem)
			...
			list.Add(New DataItem() With {.Employee = EmployeeA, .Widget = WidgetA, .Month = 6, .RetailPrice = 45.6, .WholesalePrice = 40, .Quantity = 3, .Remains = 0})
			list.Add(New DataItem() With {.Employee = EmployeeA, .Widget = WidgetA, .Month = 7, .RetailPrice = 38.9, .WholesalePrice = 30, .Quantity = 6, .Remains = 1})
			list.Add(New DataItem() With {.Employee = EmployeeA, .Widget = WidgetB, .Month = 6, .RetailPrice = 24.7, .WholesalePrice = 20, .Quantity = 7, .Remains = 0})
			list.Add(New DataItem() With {.Employee = EmployeeA, .Widget = WidgetB, .Month = 7, .RetailPrice = 8.3, .WholesalePrice = 7.5, .Quantity = 5, .Remains = 1})
			list.Add(New DataItem() With {.Employee = EmployeeA, .Widget = WidgetC, .Month = 6, .RetailPrice = 10.0, .WholesalePrice = 9, .Quantity = 4, .Remains = 0})
			list.Add(New DataItem() With {.Employee = EmployeeA, .Widget = WidgetC, .Month = 7, .RetailPrice = 20.0, .WholesalePrice = 18.5, .Quantity = 5, .Remains = 1})
			list.Add(New DataItem() With {.Employee = EmployeeB, .Widget = WidgetA, .Month = 6, .RetailPrice = 77.8, .WholesalePrice = 70, .Quantity = 2, .Remains = 0})
			list.Add(New DataItem() With {.Employee = EmployeeB, .Widget = WidgetA, .Month = 7, .RetailPrice = 32.5, .WholesalePrice = 30, .Quantity = 1, .Remains = 1})
			list.Add(New DataItem() With {.Employee = EmployeeB, .Widget = WidgetB, .Month = 6, .RetailPrice = 12, .WholesalePrice = 11, .Quantity = 10, .Remains = 0})
			list.Add(New DataItem() With {.Employee = EmployeeB, .Widget = WidgetB, .Month = 7, .RetailPrice = 6.7, .WholesalePrice = 5.5, .Quantity = 4, .Remains = 1})
			list.Add(New DataItem() With {.Employee = EmployeeB, .Widget = WidgetC, .Month = 6, .RetailPrice = 30.0, .WholesalePrice = 28.7, .Quantity = 6, .Remains = 0})
			list.Add(New DataItem() With {.Employee = EmployeeB, .Widget = WidgetC, .Month = 7, .RetailPrice = 40.0, .WholesalePrice = 38.3, .Quantity = 7, .Remains = 1})
			Return list
		End Function
	End Class
End Namespace
